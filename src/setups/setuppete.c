...
u32 props[] = {
	...
	beginobjective(0, L_PETE_009, (DIFFBIT_A | DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_DA | DIFFBIT_PD)) // "Retrieve drop point equipment"
		require_object_collected(OBJ_BRIEFCASE1)
		require_object_collected(OBJ_BRIEFCASE2)
	endobjective

	beginobjective(1, L_PETE_010, (DIFFBIT_PA | DIFFBIT_DA | DIFFBIT_PD)) // "Attach tracer to limousine"
	...
	beginobjective(2, L_PETE_011, (DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_DA | DIFFBIT_PD)) // "Prepare escape route"
		complete_flags(STAGEFLAG_MINE_PLACED)
		fail_flags(STAGEFLAG_MINE_WASTED)
	endobjective

	beginobjective(3, L_PETE_013, (DIFFBIT_A | DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_DA | DIFFBIT_PD)) // "Create vehicular diversion"
		complete_flags(STAGEFLAG_DIVERSION_CREATED)
		fail_flags(STAGEFLAG_TAXI_DESTROYED)
		fail_flags(STAGEFLAG_ROBOT_DESTROYED)
	endobjective

	beginobjective(4, L_PETE_014, (DIFFBIT_A | DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_DA | DIFFBIT_PD)) // "Gain entry to G5 building"
	...
	chr(SPAWNFLAG_ONLYONSA | SPAWNFLAG_ONLYONPA | SPAWNFLAG_ONLYONDA, 0x17, PAD_PETE_00AB, BODY_FBIGUY, HEAD_RANDOM, 0x0411, -1, -1, 800, 30, CHRFLAG0_SKIPSAFETYCHECKS | CHRFLAG0_00008000 | CHRFLAG0_CANLOSEGUN, 0, TEAM_20, SQUADRON_00, -1, 0, 0, 0, 0, 0)
	...
	chr(SPAWNFLAG_ONLYONPA | SPAWNFLAG_ONLYONDA, 0x18, PAD_PETE_00AF, BODY_FBIGUY, HEAD_RANDOM, 0x0411, -1, -1, 500, 30, CHRFLAG0_CAN_EXAMINE_BODY | CHRFLAG0_SKIPSAFETYCHECKS | CHRFLAG0_FORCESAFETYCHECKS | CHRFLAG0_00008000 | CHRFLAG0_CANLOSEGUN, 0, TEAM_20, SQUADRON_01, -1, 0, 1, 0, 0, 0)
	...
	chr(SPAWNFLAG_ONLYONPA | SPAWNFLAG_ONLYONDA | SPAWNFLAG_BASICGUARD, 0x09, PAD_PETE_00CC, BODY_G5_GUARD, HEAD_RANDOM, 0x040f, -1, -1, 1000, 10, CHRFLAG0_CAN_EXAMINE_BODY | CHRFLAG0_SKIPSAFETYCHECKS | CHRFLAG0_CAMP | CHRFLAG0_HEAR_REQUIRE_LOS | CHRFLAG0_CANLOSEGUN, 0, TEAM_20, SQUADRON_04, -1, 0, 0, 0, 0, 0)
	weapon(0x0100, MODEL_CHRCMP150, 0x0009, OBJFLAG_ASSIGNEDTOCHR, 0, 0, WEAPON_CMP150)
