...
u32 props[] = {
	...
	chr(SPAWNFLAG_BASICGUARD, 0x00, PAD_ATE_0279, BODY_DDSHOCK, HEAD_RANDOM, AILIST_GUARD_INIT, -1, -1, 100, 100, CHRFLAG0_CAN_THROW_GRENADES | CHRFLAG0_SQUADALERTANYDIST | CHRFLAG0_HOLD_POSITION | CHRFLAG0_COVER_TYPE2 | CHRFLAG0_HEAR_REQUIRE_LOS, CHRFLAG1_STOPTRACKINGIFLOOKEDAT, TEAM_ENEMY, SQUADRON_04, -1, 0, 0, 0, 0, 0)
	weapon(0x0100, MODEL_CHRFALCON2, CHR_GUARD, OBJFLAG_ASSIGNEDTOCHR, 0, 0, WEAPON_FALCON2_SCOPE)
	chr(SPAWNFLAG_BASICGUARD, 0x01, PAD_ATE_0023, BODY_CISOLDIER, HEAD_JONATHAN, AILIST_JON_INIT, -1, -1, 100, 100, CHRFLAG0_CAN_THROW_GRENADES | CHRFLAG0_SQUADALERTANYDIST | CHRFLAG0_HOLD_POSITION | CHRFLAG0_COVER_TYPE2 | CHRFLAG0_HEAR_REQUIRE_LOS, CHRFLAG1_STOPTRACKINGIFLOOKEDAT, TEAM_ENEMY, SQUADRON_04, -1, 0, 0, 0, 0, 0)
	weapon(0x0100, MODEL_CHRDY357, CHR_JONATHAN, OBJFLAG_ASSIGNEDTOCHR, 0, 0, WEAPON_DY357MAGNUM)
	chr(SPAWNFLAG_BASICGUARD, 0x02, PAD_ATE_0024, BODY_TRENT, HEAD_TRENT, AILIST_TRENT_INIT, -1, -1, 100, 100, CHRFLAG0_CAN_THROW_GRENADES | CHRFLAG0_SQUADALERTANYDIST | CHRFLAG0_HOLD_POSITION | CHRFLAG0_COVER_TYPE2 | CHRFLAG0_HEAR_REQUIRE_LOS, CHRFLAG1_STOPTRACKINGIFLOOKEDAT, TEAM_ENEMY, SQUADRON_04, -1, 0, 0, 0, 0, 0)
...
u8 func1002_first_walk[] = {
	...
	chr_move_to_pad(CHR_GUARD, PAD_ATE_0274, TRUE, /*goto*/ 0x0b)
...
u8 func1007_second_walk[] = {
	...
	chr_move_to_pad(CHR_JONATHAN, PAD_ATE_0279, TRUE, /*goto*/ 0x2d)
	yield
	goto_first(0x8f)
	...
	chr_move_to_pad(CHR_JONATHAN, PAD_ATE_0271, TRUE, /*goto*/ 0x0b)
	label(0x8f)
	chr_move_to_pad(CHR_JONATHAN, PAD_ATE_0270, TRUE, /*goto*/ 0x0b)
...
u8 func0401_move_to_pad[] = {
	chr_move_to_pad(CHR_SELF, PAD_ATE_027A, TRUE, /*goto*/ 0x06)
	label(0x06)
	yield
	stop_chr
	set_ailist(CHR_SELF, GAILIST_IDLE)
...
u8 func1008_third_walk[] = {
	...
	label(0x8f)
	set_ailist(CHR_P1P2, AILIST_MOVE_TO_PAD)
	chr_move_to_pad(CHR_TRENT, PAD_ATE_0279, TRUE, /*goto*/ 0x2d)
	yield
	goto_first(0x8f)
	...
	enter_firstperson
	force_walk(CHR_BOND, 0x0275, 40, 5, 0, 100)
	chr_move_to_pad(CHR_TRENT, PAD_ATE_0272, TRUE, /*goto*/ 0x0b)
...
u8 func0402_guard_combat[] = {
	...
	beginloop(0x04)
		...
		if_target_aiming_at_me(/*goto*/ 0x2d)
	endloop(0x04)
...
u8 func0404_trent_combat[] = {
	...
	beginloop(0x04)
		...
		if_target_aiming_at_me(/*goto*/ 0x03)
	endloop(0x04)
