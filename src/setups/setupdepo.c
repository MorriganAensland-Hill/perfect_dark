...
u32 props[] = {
	...
	tag(OBJ_GENERATOR, 1)
	multimonitor(0x0100, MODEL_PD_CONSOLE, PAD_DEPO_00D0, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SCROLL_TEXT_GREEN, TVPROGRAM_SCROLL_TEXT_GREEN, TVPROGRAM_DEFAULT, TVPROGRAM_DEFAULT)
	tag(0x3f, 1)
...
#else
	stdobject(0x0100, MODEL_ZIGGYCARD, PAD_DEPO_1DF6B8A4, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_COLLECTABLE | OBJFLAG_BOUNCEIFSHOT | OBJFLAG_01000000, OBJFLAG2_IMMUNETOGUNFIRE, OBJFLAG3_ONSHELF, 1000)
#endif
	...
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00ED, OBJFLAG_00000002, 0, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_BARS_YELLOW)
	tag(0x03, 1)
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00E6, OBJFLAG_00000002, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SOLID_GREEN)
	tag(0x04, 1)
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00E8, OBJFLAG_00000002, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SOLID_GREEN)
	tag(0x05, 1)
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00E9, OBJFLAG_00000002, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SOLID_GREEN)
	tag(0x06, 1)
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00EA, OBJFLAG_00000002, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SOLID_GREEN)
	tag(0x12, 1)
	singlemonitor(0x0019, MODEL_G5_ALARM, PAD_DEPO_00E7, OBJFLAG_00000002, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_IMMUNETOEXPLOSIONS, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SCROLLUP_TEXT_RED)
	tag(0x13, 1)
	singlemonitor(0x0019, MODEL_G5_ALARM, PAD_DEPO_00EB, OBJFLAG_00000002, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_IMMUNETOEXPLOSIONS, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SCROLLUP_TEXT_RED)
	tag(OBJ_SAFEKEYPAD, 1)
	singlemonitor(0x0019, MODEL_G5_LASER_SWITCH, PAD_DEPO_00EC, OBJFLAG_00000002, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, TVPROGRAM_SINEWAVE1)
	tag(OBJ_SAFEDOOR, 1)
	...
	glass(0x0100, MODEL_WINDOW, PAD_DEPO_00C0, OBJFLAG_00000002 | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_ORTHOGONAL | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_PATHBLOCKER, OBJFLAG2_BULLETPROOF, 0, 1000)
	glass(0x0100, MODEL_WINDOW, PAD_DEPO_00C1, OBJFLAG_00000002 | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_ORTHOGONAL | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_PATHBLOCKER, OBJFLAG2_BULLETPROOF, 0, 1000)
	glass(0x0100, MODEL_WINDOW, PAD_DEPO_00BE, OBJFLAG_00000002 | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_ORTHOGONAL | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_PATHBLOCKER, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_BULLETPROOF, 0, 1000)
	tag(0x22, 4)
	tag(0x23, 4)
	tag(0x24, 4)
	tag(0x25, 4)
	...
	door(0x0100, MODEL_G5_ESCDOORUP, PAD_DEPO_00F0, OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_PATHBLOCKER | OBJFLAG_UNCOLLECTABLE | OBJFLAG_FORCENOBOUNCE | OBJFLAG_01000000 | OBJFLAG_CANNOT_ACTIVATE | OBJFLAG_DEACTIVATED, OBJFLAG2_NOFALL | OBJFLAG2_FALLWITHOUTROTATION | OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_BULLETPROOF | OBJFLAG2_IMMUNETOEXPLOSIONS | OBJFLAG2_AICANNOTUSE, 0, 1000, 0x00000000, 0x00010000, 0x03e80000, 0x03e80000, 0x00010000, 0, DOORTYPE_SLIDING, 0x00000080, 0x00000001, 0x00010000, 0x00000000, 0x00000000)
#if VERSION >= VERSION_NTSC_1_0
	...
	conditional_scenery(1, 0, 2)
	door(0x0100, MODEL_G5_ESCDOORDOWN, PAD_DEPO_00EE, OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR | OBJFLAG_PATHBLOCKER | OBJFLAG_UNCOLLECTABLE | OBJFLAG_FORCENOBOUNCE | OBJFLAG_01000000 | OBJFLAG_CANNOT_ACTIVATE | OBJFLAG_DEACTIVATED, OBJFLAG2_NOFALL | OBJFLAG2_FALLWITHOUTROTATION | OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_BULLETPROOF | OBJFLAG2_IMMUNETOEXPLOSIONS | OBJFLAG2_AICANNOTUSE, 0, 1000, 0x00000000, 0x00010000, 0x03e80000, 0x03e80000, 0x00010000, 0, DOORTYPE_SLIDING, 0x00000080, 0x00000001, 0x00010000, 0x00000000, 0x00000000)
#if VERSION >= VERSION_NTSC_1_0
	...
	stdobject(0x0100, MODEL_DUMPSTER, PAD_DEPO_00F9, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_INVINCIBLE, 0, 0, 1000)
	stdobject(0x0100, MODEL_DUMPSTER, PAD_DEPO_00FA, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_INVINCIBLE, 0, 0, 1000)
	stdobject(0x0100, MODEL_DUMPSTER, PAD_DEPO_00FB, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_INVINCIBLE, 0, 0, 1000)
	stdobject(0x0100, MODEL_DUMPSTER, PAD_DEPO_00FC, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_INVINCIBLE, 0, 0, 1000)
#if VERSION >= VERSION_NTSC_1_0
...
#else
	stdobject(0x0028, MODEL_BAFTA, PAD_DEPO_2B94077E, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_BOUNCEIFSHOT, 0, 0, 1000)
#endif
	stdobject(0x0133, MODEL_G5SMALLCHAIR, PAD_DEPO_00F3, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, 0, OBJFLAG3_PUSHABLE, 1000)
	stdobject(0x0133, MODEL_G5SMALLCHAIR, PAD_DEPO_00F4, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, 0, OBJFLAG3_PUSHABLE, 1000)
	stdobject(0x0133, MODEL_G5SMALLCHAIR, PAD_DEPO_00F5, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, 0, OBJFLAG3_PUSHABLE, 1000)
	stdobject(0x0133, MODEL_G5SMALLCHAIR, PAD_DEPO_00F6, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, 0, OBJFLAG3_PUSHABLE, 1000)
	stdobject(0x0133, MODEL_G5SMALLCHAIR, PAD_DEPO_00F7, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, 0, OBJFLAG3_PUSHABLE, 1000)
	tag(0x4a, 1)
	...
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00C8, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00C9, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CA, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CB, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CC, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CD, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CE, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)
	stdobject(0x0100, MODEL_G5_MAINFRAME, PAD_DEPO_00CF, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_YTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE | OBJFLAG_IGNOREFLOORCOLOUR, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_PUSHABLE, 500)

	tag(0x3c, 1)
	weapon(0x0080, MODEL_MULTI_AMMO_CRATE, PAD_DEPO_0095, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, 0, 0, WEAPON_NBOMB)
...
u8 func1008_check_generator[] = {
	beginloop(0x04)
		...
		set_object_image(OBJ_GENERATOR, 0, TVPROGRAM_SOLID_BLACK)
		set_object_image(OBJ_GENERATOR, 1, TVPROGRAM_SOLID_BLACK)
		mute_channel(CHANNEL_4)
...
u8 func1003_laser_switch_1[] = {
	...
	beginloop(0x04)
		...
		// Deactivated
		set_object_image(OBJ_LASERSWITCH1, 0, TVPROGRAM_SOLID_BLACK)
		...
		mute_channel(CHANNEL_0)
		assign_sound(SFXNUM_01CD_PICKUP_SHIELD, CHANNEL_0)
		...
		set_object_image(OBJ_LASERSWITCH1, 0, TVPROGRAM_SOLID_GREEN)
...
u8 func1004_laser_switch_2[] = {
	assign_sound(SFXMAP_8119, CHANNEL_1)
	...
	beginloop(0x04)
		...
		// Deactivated
		set_object_image(OBJ_LASERSWITCH2, 0, TVPROGRAM_SOLID_BLACK)
		show_hudmsg(CHR_P1P2, L_DEPO_027) // "Laser grid unit shut down."
		...
		assign_sound(SFXNUM_01CD_PICKUP_SHIELD, CHANNEL_1)
		bind_channel_to_entity(CHANNEL_1, OBJ_LASER_2A, 0x012c, 0x0190, 0x00)
		goto_next(0x0a)

		// Activated
		label(0x09)
		set_object_image(OBJ_LASERSWITCH2, 0, TVPROGRAM_SOLID_GREEN)
		show_hudmsg(CHR_P1P2, L_DEPO_028) // "Laser grid unit activated."
...
u8 func1005_laser_switch_3[] = {
	...
	beginloop(0x04)
		...
		// Deactivated
		set_object_image(OBJ_LASERSWITCH3, 0, TVPROGRAM_SOLID_BLACK)
		show_hudmsg(CHR_P1P2, L_DEPO_027) // "Laser grid unit shut down."
		...
		assign_sound(SFXNUM_01CD_PICKUP_SHIELD, CHANNEL_2)
		bind_channel_to_entity(CHANNEL_2, OBJ_LASER_3A, 0x012c, 0x0190, 0x00)
		goto_next(0x0a)

		// Activated
		label(0x09)
		set_object_image(OBJ_LASERSWITCH3, 0, TVPROGRAM_SOLID_GREEN)
		show_hudmsg(CHR_P1P2, L_DEPO_028) // "Laser grid unit activated."
...
u8 func1006_laser_switch_4[] = {
	assign_sound(SFXMAP_811A, CHANNEL_3)
	...
	beginloop(0x04)
		...
		// Deactivated
		set_object_image(OBJ_LASERSWITCH4, 0, TVPROGRAM_SOLID_BLACK)
		show_hudmsg(CHR_P1P2, L_DEPO_027) // "Laser grid unit shut down."
		...
		assign_sound(SFXNUM_01CD_PICKUP_SHIELD, CHANNEL_3)
		bind_channel_to_entity(CHANNEL_3, OBJ_LASER_4A, 0x012c, 0x0190, 0x00)
		goto_next(0x0a)

		// Activated
		label(0x09)
		set_object_image(OBJ_LASERSWITCH4, 0, TVPROGRAM_SOLID_GREEN)
		show_hudmsg(CHR_P1P2, L_DEPO_028) // "Laser grid unit activated."
...
u8 func1010_safe_cracking[] = {
	...
	label(0x06)
	speak(CHR_BOND, L_DEPO_038, MP3_ZZ(FILE_AVAULT2M), CHANNEL_5, COLOR_00_GREEN) // "INTRUDER ALERT - all security to the vault."
	...
	label(0x06)
	mute_channel(CHANNEL_1)
	assign_sound(SFXMAP_8145, CHANNEL_1)
...
u8 func040d_intro[] = {
	...
	set_chr_hiddenflag(CHR_INTRO_VICTIM, CHRHFLAG_FINDROOMSFAST)
	...
	label(0x06)
	play_sound(SFXNUM_002E, CHANNEL_7)
	...
	label(0x06)
	play_sound(SFXNUM_0045, CHANNEL_6)
	...
	label(0x06)
	play_sound(SFXNUM_0087_M_ARGH, CHANNEL_5)
	...
	label(0x06)
	play_sound(SFXNUM_007A, CHANNEL_7)
	...
	label(0x06)
	play_sound(SFXNUM_007C, CHANNEL_6)
	...
	label(0x06)
	play_sound(SFXNUM_0082, CHANNEL_5)
...
u8 func040e_meeting_cutscene[] = {
	...
	set_chr_hiddenflag(CHR_STRIPES, CHRHFLAG_FINDROOMSFAST)
	...
	label(0x06)
	speak(CHR_BOND, L_DEPO_072, MP3_ZZ(FILE_AP8_01_DVM), CHANNEL_5, COLOR_04_ORANGE) // "We've recovered the sapient from Carrington and al..."

	wait_until(752, 0x56)
	play_sound(SFXNUM_0161, CHANNEL_6)

	wait_until(760, 0x57)
	speak(CHR_BOND, L_DEPO_073, MP3_ZZ(FILE_AP8_02_BLM), CHANNEL_7, COLOR_03_RED) // "This will reduce its efficiency. My team will have..."
	...
	play_sound(SFXNUM_0593, CHANNEL_6)

	wait_until(1684, 0x5d)
	speak(CHR_BOND, L_DEPO_074, MP3_ZZ(FILE_AP8_03_DVM), CHANNEL_5, COLOR_04_ORANGE) // "No one could have predicted that! And I resent bei..."

	wait_until(1780, 0x5e)
	play_sound_from_object(CHANNEL_6, 0x3a, SFXNUM_01D5_INVEST_LIFT_ARRIVE, PSTYPE_NONE, 0)

	wait_until(2050, 0x60)
	play_sound_from_object(CHANNEL_7, 0x3a, SFXNUM_00EC, PSTYPE_NONE, 0)

	wait_until(2070, 0x5f)
	open_door(0x3a)
	play_sound_from_object(CHANNEL_CUTSCENE, 0x3a, SFXMAP_81B0_DOOR, PSTYPE_NONE, 0)
	...
	speak(CHR_BOND, L_DEPO_075, MP3_ZZ(FILE_AP8_04_BLM), CHANNEL_7, COLOR_03_RED) // "The President turned down your request for the loa..."
	...
	speak(CHR_BOND, L_DEPO_076, MP3_ZZ(FILE_AP8_06_BLM), CHANNEL_7, COLOR_03_RED) // "Could it be you overestimated your influence over ..."
	...
	speak(CHR_BOND, L_DEPO_077, MP3_ZZ(FILE_AP8_07_TRM), CHANNEL_7, COLOR_05_GREEN) // "No! Perhaps I underestimated his resolve. We have ..."
	...
	speak(CHR_BOND, L_DEPO_078, MP3_ZZ(FILE_AP8_08_DVM), CHANNEL_7, COLOR_04_ORANGE) // "Ha! Assuming you don't get any interference. If Ca..."
	...
	speak(CHR_BOND, L_DEPO_079, MP3_ZZ(FILE_AP8_09_TRM), CHANNEL_5, COLOR_05_GREEN) // "There will be no outside help for Mr. Carrington. ..."
	...
	speak(CHR_BOND, L_DEPO_080, MP3_ZZ(FILE_AP8_10_BLM), CHANNEL_5, COLOR_03_RED) // "Then the devices we gave you are working correctly..."
...
u8 func040f_outro[] = {
	...
	wait_until(768, 0x73)
	speak(CHR_P1P2, L_DEPO_081, MP3_ZZ(FILE_AP9_01_JOM), CHANNEL_7, COLOR_09_BLUE) // "Agent Dark reporting in! Prepare to receive a down..."

	wait_until(1280, 0x59)

	wait_until(1310, 0x75)
	speak(CHR_P1P2, L_DEPO_082, MP3_ZZ(FILE_AP9_02_CAM), CHANNEL_7, COLOR_06_WHITE) // "No time for that now, Agent Dark. There's been a d..."
	...
	speak(CHR_P1P2, L_DEPO_083, MP3_ZZ(FILE_AP9_03_JOM), CHANNEL_7, COLOR_09_BLUE) // "Area 51? But what about the President?"
...
u8 func1019_generator_hum[] = {
	yield
	assign_sound(SFXMAP_8146, CHANNEL_4)
...
u8 func101d_init_mines[] = {
	...
	unset_object_flag(OBJ_MINE1, OBJFLAG_CORE_GEO_INUSE)
	unset_object_flag(OBJ_MINE2, OBJFLAG_CORE_GEO_INUSE)
	set_chr_team(CHR_ANTI, TEAM_ENEMY)
...
u8 func101e_msg_nowaythrough[] = {
	...
	label(0x2c)
	speak(CHR_P1P2, L_DEPO_060, MP3_ZZ(FILE_AM3_L2_AM), CHANNEL_6, COLOR_09_BLUE) // "There's no way through while those lasers are acti..."
	label(0x0d)
	set_ailist(CHR_SELF, GAILIST_IDLE)
	endlist
};
...
u8 func101f_msg_meetingroomahead[] = {
	...
	label(0x2c)
	speak(CHR_P1P2, L_DEPO_061, MP3_ZZ(FILE_AM3_L2_BM), CHANNEL_6, COLOR_09_BLUE) // "That must be the meeting room up ahead. Time to us..."
...
u8 func1020_msg_heavilyencrypted[] = {
	...
	label(0x2c)
	speak(CHR_P1P2, L_DEPO_062, SFXMAP_817C, CHANNEL_6, COLOR_09_BLUE) // "The safe's heavily encrypted. The decoder's gonna ..."
	set_ailist(CHR_SELF, GAILIST_IDLE)
	endlist
};
...
u8 func1021_blow_mines[] = {
	...
	label(0x2c)
	if_difficulty_lt(DIFF_SA, /*goto*/ 0x2c)
	speak(CHR_P1P2, L_DEPO_063, MP3_ZZ(FILE_AM3_L2_DM), CHANNEL_6, COLOR_09_BLUE) // "Time to leave! Let's get to the door I set up earl..."
	set_ailist(CHR_SELF, GAILIST_IDLE)
	...
	label(0x2c)
	speak(CHR_P1P2, L_DEPO_065, SFXMAP_81A2, CHANNEL_6, COLOR_09_BLUE) // "Stand back, Joanna. We'll create your escape route..."
	restart_timer
